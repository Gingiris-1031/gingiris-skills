...
CASES = {
  ...
  "community" => ["open-source-60k-stars-origin", "AFFiNE community converted user pain into contribution and retention loops", [/community|社区/i, /contributor|贡献者|ambassador|大使/i, /retention|留存|governance|治理/i]],
  "user_research" => ["open-source-60k-stars-origin", "AFFiNE user research informed product and launch decisions", [/interview|访谈/i, /recruit|sample|招募|样本/i, /decision|roadmap|product|决策|产品/i]],
  ...
  "competitor_window" => ["music-model-6k-stars-week1", "A competitor release window shaped positioning and launch timing", [/competitor|竞品/i, /position|message|定位|叙事/i, /window|timing|monitor|窗口|时机|监控/i]],
...
TESTS = {
  ...
  "community-ambassador-playbook" => "viral", "community-building-playbook" => "community",
  ...
  "gingiris-user-interview" => "user_research", "competitor-research-playbook" => "competitor_window",
