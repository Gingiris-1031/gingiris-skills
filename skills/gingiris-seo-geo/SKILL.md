...
when_to_use: |
  Use this skill when you need to: rank on Google AND get cited by AI search (ChatGPT,
  Perplexity, Claude, Gemini), build keyword funnel strategy, implement JSON-LD schema,
  write E-E-A-T content, create comparison pages, set up IndexNow, or run GEO optimization.
  Trigger phrases: "SEO" | "GEO" | "AI search" | "keyword strategy" | "schema markup" |
  "搜索优化" | "GEO优化" | "AI搜索引用" | "生成式引擎优化" | "内容SEO"
...
| Content cadence proven effective | 4 articles/week, KD 30-50 long-tail keywords |
