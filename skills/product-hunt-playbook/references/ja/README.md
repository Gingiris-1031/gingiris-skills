# Product Hunt ローンチ・プレイブック

> **デイリー1位 30回 | ウィークリー1位 3回 | マンスリー1位 1回**

## 得られること

- 📅 **24時間バトルプラン** — ローンチ当日の時間別タクティクス
- 🎯 **ランキングアルゴリズムの洞察** — PH ランキングの実際の仕組み
- 👥 **コミュニティ動員** — ルール違反なくネットワークを活性化する方法
- 💬 **メイカーコメント戦略** — 投票者との効果的なエンゲージメント
- 📊 **ローンチ後のモメンタム** — PH トラフィックをユーザーに転換
...
**[Product Hunt ローンチ アクションガイド](https://gingiris.gumroad.com/l/zxamur)** — ¥99
- 完全な時間別タイムライン
- ハンター選定フレームワーク
- コミュニティ動員テンプレート
- ローンチ後コンバージョン・プレイブック

**[コンプリート・ローンチ・バンドル](https://gingiris.gumroad.com/l/gingiris-complete-global-launch-bundle)** — 全4プレイブックセット

## 🎯 1対1 ローンチ・コーチング

**Iris と直接協業（PH デイリー1位 30回達成、AFFiNE 共同創業者）：**

| サービス | 価格 | 最適な用途 |
|---------|------|----------|
| 30分セッション | ¥800 | クイック・ローンチ・レビュー |
